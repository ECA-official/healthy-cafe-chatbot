...
const PAYMENT_DETAILS = {
  "862654046938799": {
    ...
    qrImage: "https://raw.githubusercontent.com/prcaraudio-dev/healthy-cafe-chatbot/main/Qrmadam.jpg" // ชื่อไฟล์รูปที่วางหน้าแรกคู่กับ sever.js
  },
  "825790847294552": {
    accountName: "น.ส.อินทิรา ณ พัทลุง",
    bankName: "พร้อมเพย์",
    accountNumber: "081-5659698",
    qrImage: "https://raw.githubusercontent.com/prcaraudio-dev/healthy-cafe-chatbot/main/Qrann.jpg" // ชื่อไฟล์รูปที่วางหน้าแรกคู่กับ sever.js
  },
   "1295046180355252": {
    accountName: "นาย วุฒิชัย แก้วนิล",
    bankName: "พร้อมเพย์",
    accountNumber: "099-7012530",
    qrImage: "https://raw.githubusercontent.com/prcaraudio-dev/healthy-cafe-chatbot/main/Qrjackport.jpg" // ชื่อไฟล์รูปที่วางหน้าแรกคู่กับ sever.js
  }
};    
...
1. การส่งรายละเอียดโปรแกรม และ โปรโมชั่นสิทธิ์ฟรี:
   - ส่งรายละเอียดโปรแกรม 1, 2, 3 พร้อมข้อความโปรโมชั่นสิทธิ์ตรวจสุขภาพฟรี **เฉพาะเมื่อลูกค้าทักมาครั้งแรก หรือ พิมพ์ถามหาโปรแกรม เท่านั้น!**
   - ประโยคถามรับสิทธิ์ที่ต้องใช้:
     "สนใจรับสิทธิ์ตรวจเช็คสุขภาพและรูปร่างด้วยเครื่องมือทางการแพทย์ฟรีด้วยไหมคะ? ถ้ารับสิทธิ์ให้พิมพ์ 'รับสิทธิ์' ถ้าไม่รับสิทธิ์ให้พิมพ์ 'ไม่รับสิทธิ์' มานะคะ ✨"
...
2. เมื่อลูกค้าพิมพ์สนใจ / ขอทดลอง / ยืนยันเลือกโปรแกรมเข้ามา:
   ...
   - ให้ตอบรับด้วยความยินดีสั้นๆ เช่น "ยินดีค่ะคุณลูกค้า ✨" แล้วเข้าสู่ขั้นตอนการถามข้อมูลหรือเรื่องการชำระเงินทันที

3. ขั้นตอนขอข้อมูลและการชำระเงิน:
   - เช็คว่าลูกค้าส่งข้อมูลครบ 4 ข้อหรือยัง: (1.ชื่อเล่น 2.อายุ 3.น้ำหนัก 4.ส่วนสูง)
   - หากยังไม่ครบ ให้ขอเฉพาะข้อมูลที่ขาด (ห้ามส่งรายละเอียดโปรแกรมซ้ำ)
   - หากครบแล้ว หรือลูกค้าพร้อมชำระเงิน ให้ตอบเข้าสู่ขั้นตอนการชำระเงินทันที เช่น:
     "ขอบคุณสำหรับข้อมูลนะคะ เดี๋ยวแอดมินส่งรายละเอียดการชำระเงินให้สักครู่นะคะ ✨"

4. การนัดวันเวลาหน้าร้าน:
   - หากลูกค้านัดวันเวลาเข้ามา ให้สรุปยืนยันวันเวลาอย่างสุภาพ และห้ามส่งรายละเอียดโปรแกรมหรือถามรับสิทธิ์ซ้ำอีก
