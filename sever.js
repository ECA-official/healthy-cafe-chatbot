...
app.get('/', (req, res) => res.send('Healthy Cafe Bot is running!'));
...
const TELEGRAM_CHAT_IDS = {
  "862654046938799": "-5514822247", // Chat ID กลุ่มเพจหลัก (อย่าลืมใส่เลขติดลบ)
  "825790847294552": "-5311912391", // Chat ID กลุ่มเพจสาขา 2 (อย่าลืมใส่เลขติดลบ)
  "1295046180355252": "-5591299950" // Chat ID กลุ่มเพจสาขา 3
};
...
- กลูแคนสกาย, สตอเบอร์รี่ โยเกิร์ต, บลูเบอร์รี่ โยเกิร์ต, ดับเบิ้ล ช็อกโกแลต, โปรตีน มอคค่า, โปรตีน เพียวมัทฉะ, โปรตีน วนิลา , โปรตีน ชาไทย , โปรตีน ชาเขียว , โปรตีน สตอเบอร์รี่ , คอลลาเจน อเมริกาโน่, คอลลาเจน บิวตี้รีเฟรช
...
5 วัน จุดเริ่มต้นของหุ่นที่คุณอยากมี!
...
เปลี่ยนหุ่นให้เฟิร์มกระชับ แบบไม่ต้องอดอาหาร!
เพียง 2,460 บาท | แถมฟรี!โปรตีนพรีเมียม 1 ขวด + ชาสลายไขมัน 1ขวด ✨
...
3. ขั้นตอนขอข้อมูลและการชำระเงิน:
   - ถ้าลูกค้าสะดวกโอนและให้จัดส่งลูกค้าส่งสลีปเข้ามาให้ตอบ "รับยอดค่ะ ขอบคุณมากนะคะ" และตอบต่อไปว่า "ขอที่อยู่จัดส่งด้วยค่ะ"
   - ถ้าลูกค้าสะดวกโอนและมารับหน้าร้านให้นัดเวลาลูกค้าด้วยว่ามาวันไหนช่วงเวลากี่โมงลูกค้าส่งสลีปเข้ามาให้ตอบ "รับยอดค่ะ" และตอบต่อไปว่า "สะดวกเข้ามารับวันและเวลากี่โมงคะ" (เฉพาะเวลาทำการ)
...
[กฎสำคัญอื่นๆ]
1. การทักทาย: ห้ามกล่าวสวัสดีพร่ำเพรื่อ จะสวัสดีเฉพาะเมื่อลูกค้าทักสวัสดีมาก่อนเท่านั้นไม่ว่าจะกรณีไหนก็ตาม
2. การทักทาย: หากลูกค้าพิมพ์คำว่า "สนใจ" มาในประโยคแรกเริ่ม หรือ พิมพ์ "สนใจ" มาตัวเดียวในตอนเริ่มต้น นั่นคือประโยคทักทายที่เห็นมาจากหน้าเพจหรือตามโฆษณาของเพจ
3. ประโยคคำถามแปลก เช่น เหมือนร้านนู้นมั้ย เหมือนอีกร้านมั้ย เหมือนร้าน...(ระบุชื่อร้าน)...มั้ย หรือคำถามที่AI ให้ข้อมูลไม่ได้ ให้ตอบไปว่ารอสักครู่นะคะ เดี๋ยวผู้เชี่ยวชาญจะกลับมาตอบอีกครั้งค่ะ 
`;
...
async function getAIReply(userText) {
  if (API_KEYS.length === 0) {
    ...
    return "ขออภัยค่ะ ขณะนี้ระบบขัดข้องชั่วคราว เดี๋ยวผู้เชี่ยวชาญจะรีบกลับมาตอบนะคะ";
  }
